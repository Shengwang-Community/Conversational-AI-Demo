...
extension ResourceManager {
    ...
    enum L10n {
        ...
        public enum DevMode {
            public static let fieldEnabled = ResourceManager.localizedString("devmode.field.enabled")
            public static let fieldDisabled = ResourceManager.localizedString("devmode.field.disabled")
            public static let appVersion = ResourceManager.localizedString("devmode.app.version")
            public static let bundleId = ResourceManager.localizedString("devmode.bundle.id")
            public static let appId = ResourceManager.localizedString("devmode.app.id")
            public static let convoaiHost = ResourceManager.localizedString("devmode.convoai.host")
            public static let notSelected = ResourceManager.localizedString("devmode.not.selected")
            public static let noOverride = ResourceManager.localizedString("devmode.no.override")
            public static let unavailable = ResourceManager.localizedString("devmode.unavailable")
            public static let copied = ResourceManager.localizedString("devmode.copied")
            public static let loadAppIdsFailed = ResourceManager.localizedString("devmode.load.app.ids.failed")
            public static let switchedEnvironment = ResourceManager.localizedString("devmode.switched.environment")
            public static let fieldSaved = ResourceManager.localizedString("devmode.field.saved")
            public static let fieldCleared = ResourceManager.localizedString("devmode.field.cleared")
            public static let sdkParamsHint = ResourceManager.localizedString("devmode.sdk.params.hint")
            public static let requestBaseURL = ResourceManager.localizedString("devmode.request.base.url")
            public static let requestBaseURLHint = ResourceManager.localizedString("devmode.request.base.url.hint")
            public static let requestBaseURLDescription = ResourceManager.localizedString("devmode.request.base.url.desc")
            public static let requestNamespace = ResourceManager.localizedString("devmode.request.namespace")
