...
class VoiceprintRecordViewController: UIViewController {
    ...
    private lazy var closeButton: UIButton = {
        ...
        button.backgroundColor = UIColor.themColor(named: "ai_icontext3")
        button.layer.cornerRadius = 12
        button.setImage(UIImage.ag_named("ic_agent_setting_close"), for: .normal)
    ...
    private lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = ResourceManager.L10n.VoiceprintMode.pleaseRead
    ...
    private lazy var timeLabel: UILabel = {
        let label = UILabel()
        label.text = String(format: ResourceManager.L10n.VoiceprintMode.recordingTime, 0)
    ...
    private lazy var instructionLabel: UILabel = {
        let label = UILabel()
        label.text = ResourceManager.L10n.VoiceprintMode.recordingInstruction
        label.font = .systemFont(ofSize: 12, weight: .regular)
        label.textColor = UIColor.white.withAlphaComponent(0.75)
        label.textAlignment = .center
        return label
    ...
    private lazy var recordingButton: UIButton = {
        ...
        button.setTitle(ResourceManager.L10n.VoiceprintMode.holdToRecord, for: .normal)
    ...
    private func updateUIForRecordingState() {
        ...
        titleLabel.text = ResourceManager.L10n.VoiceprintMode.recordingTitle
        timeLabel.isHidden = false
        instructionLabel.text = ResourceManager.L10n.VoiceprintMode.recordingInstruction
    ...
    private func updateUIForIdleState() {
        ...
        titleLabel.text = ResourceManager.L10n.VoiceprintMode.pleaseRead
        timeLabel.isHidden = true
        instructionLabel.text = ResourceManager.L10n.VoiceprintMode.warning
        instructionLabel.isHidden = false
        lineWaveAnimationView.isHidden = true
        
        recordingButton.backgroundColor = UIColor(hex: "#555B69")
        recordingButton.setTitle(ResourceManager.L10n.VoiceprintMode.holdToRecord, for: .normal)
    }
    ...
    private func updateTimeLabel() {
        ...
        timeLabel.text = String(format: ResourceManager.L10n.VoiceprintMode.recordingTime, currentTime)
    }
